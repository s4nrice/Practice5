package ru.mirea.zyryanov.audiorecord;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startRecordButton = (Button) findViewById(R.id.start_record_button);
        startRecordButton.setOnClickListener(this::onRecordStartClick);
        stopRecordButton = (Button) findViewById(R.id.stop_record_button);
        stopRecordButton.setOnClickListener(this::onRecordStopClick);
